...
public class PremiumFragment extends Fragment implements FirestoreAdapter2.OnListItemClick2{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView2.addItemDecoration(new PremiumFragment.GridSpacingItemDecoration(2, 15, false));
